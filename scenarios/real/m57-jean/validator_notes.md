...
**Role:** Adversarial validator. Steel-manning the null hypothesis (Jean did not exfiltrate the spreadsheet, or did so for reasons the analyst has not established). Every challenge below is grounded in the extracted artifacts in `analysis/m57-jean/`.
