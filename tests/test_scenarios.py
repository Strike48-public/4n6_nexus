...
from tests.scenario_harness import SCENARIOS, run_scenario
...
def test_scenario_precision_and_recall(expectation):
    ...
    result = run_scenario(expectation, REPO_ROOT)
...
def test_clean_baseline_has_zero_findings():
    ...
    result = run_scenario(clean, REPO_ROOT)
...
def test_ransomware_confidence_recovers_via_event_log():
    ...
    result = run_scenario(ransomware, REPO_ROOT)
