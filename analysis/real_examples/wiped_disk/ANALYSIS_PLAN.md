...
**Output Files**:
- `analysis/real_examples/wiped_disk/carved_executables/exe_*.exe` - All carved files
- `analysis/real_examples/wiped_disk/executable_analysis_report.json` - Analysis results
