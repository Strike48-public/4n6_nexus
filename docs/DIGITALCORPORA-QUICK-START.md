...
```bash
cd ~/Code/4n6_nexus/scripts/download-corpora
...
- **Full Catalog:** `~/Code/4n6_nexus/docs/digitalcorpora-comprehensive-catalog.md`
- **Download Scripts:** `~/Code/4n6_nexus/scripts/download-corpora/`
...
**Want details?** Read the [Full Catalog](~/Code/4n6_nexus/docs/digitalcorpora-comprehensive-catalog.md)
