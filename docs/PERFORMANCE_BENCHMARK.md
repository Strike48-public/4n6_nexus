...
**Synthetic Scenarios (16 scenarios, perfect control):**
...
**Synthetic Scenarios:**
- 16 scenarios run by the harness (anti-forensics, malware, intrusion, data
  exfiltration, memory), 62 findings at F1=1.00. See ACCURACY_REPORT.md.
