...
|---|---|---|---|---|
| Synthetic | 16 scenarios (harness) | Hand-authored | ✅ harness | 62 findings, F1 = 1.00 (0 FP / 0 FN) |
...
**What was tested and found (16 scenarios actually run, F1 = 1.00):**
...
| 10_timestomping_with_bam | Timestomping corroborated by BAM | 2 |
...
| 22_lateral_movement_logons | Remote-logon lateral movement (Event ID 4624) | 5 |
| 23_distributed_spray | Distributed password-spray across hosts | 1 |
...
- **Claimed (with run artifacts):** the synthetic harness result (62 findings,
